function rez=DA_AnalyzeSession(fl, md, eva)
...
clear EV EVENTS F Ff H MN MX blm fl blp ev evv f ffl fx i j legend lm lp mx n n1 n2 rt x1 x2
...
CTR=mean(SWEEP_DATA(1002,:))*SWEEP_DATA(4200,:)/mean(SWEEP_DATA(4200,:));
