...
for i = 1:length(stimOnTimestamps);
...
% CSD_DataBlock_IO(1,:,i) = (CSD_DataBlock(1,:,i) + CSD_DataBlock(1,:,i+1));    

% Set up CSD_DataBlock_IO which is the same as CSD_DataBlock because there
% were only one set of stims
CSD_DataBlock_IO = CSD_DataBlock;
