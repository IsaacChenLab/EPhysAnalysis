...
if exist ('TT9_cells.NTT') == 2
    ...
    [Sc9_TT_Timestamps, Sc9_TT_CellNumbers, Sc9_TT_DataPoints] = importTT ('TT9_cells.NTT');
...
if exist ('TT10_cells.NTT') == 2
    ...
    [Sc10_TT_Timestamps, Sc10_TT_CellNumbers, Sc10_TT_DataPoints] = importTT ('TT10_cells.NTT');
...
if exist ('TT11_cells.NTT') == 2
    ...
    [Sc11_TT_Timestamps, Sc11_TT_CellNumbers, Sc11_TT_DataPoints] = importTT ('TT11_cells.NTT');
...
if exist ('TT12_cells.NTT') == 2
    ...
    [Sc12_TT_Timestamps, Sc12_TT_CellNumbers, Sc12_TT_DataPoints] = importTT ('TT12_cells.NTT');
