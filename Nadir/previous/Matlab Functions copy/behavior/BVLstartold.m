...
if nargin<2
    dly=0.5; % > if we are interested in hippocampus tasks
end
if nargin<3
    N1=10;
end
...
while run_ind,
    if r(d)<0.5, %50% probability;  cs plus trial
        ...
        t(find(t==0))=10;
        t=t-10;
        oriz,for i=1:375, axis([1 5 t(i) t(i)+10]);, pause(0.01);,end,close
        %LICKS=0;
        ...
        t(find(t==0))=10;
        t=t-10;
        oriz1,for i=1:250, axis([1*cos(63) 2*cos(63) t(i)*sin(63) (t(i)+10)*sin(63)]);, pause(0.01);,end,close
        ...
        t(find(t==0))=10;
        t=t-10;
        vert,for i=1:625, axis([t(i) t(i)+10 0 10]);, pause(0.01);,end,close
    end
